angular.module('xiaoMing').config(['$stateProvider','$httpProvider', function($stateProvider,$httpProvider){
    ...
    //member
        ...
        .state('main.doc_a',{
            ...
            controller:'docAdminCtrl',
            controllerAs:'doc',
            resolve:{
                orgsS:[
                    '$ocLazyLoad',function ($ocLazyLoad) {
                        return $ocLazyLoad.load('/GaoXiaoXiaoMing/assets/js/myApp/services/docAdminService.js').then(function () {
                            return $ocLazyLoad.load('/GaoXiaoXiaoMing/assets/js/myApp/controllers/docAdminCtrl.js');
                        })
                    }
                ]
            }
