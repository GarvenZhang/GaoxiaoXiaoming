 ...
 */
angular.module('xiaoMing').controller('inviteCtrlA',['$scope','inviteServiceA',function ($scope,inviteServiceA) {
    /*
     *变量初始化
     */
    ...
    var getInviteData=function () {
        var pageNum=that.pageConfig.currentPage,
           ...
           // a=1;
        //将数据传到后端
        inviteServiceA.getInviteData(pageNum,pageSize,sort,edition);
    };
    ...
    //状态转换
    this.transformJoinState=inviteServiceA.getJoinedState;
    inviteServiceA.getOrganizationData();
