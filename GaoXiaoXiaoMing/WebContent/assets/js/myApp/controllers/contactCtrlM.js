...
angular.module('xiaoMing')
    .controller('contactNowCtrlM',['$scope','contactServiceM',function ($scope,contactServiceM) {
    /**
     *
     *初始化
     */
    ...
    var getContactNowData=function () {
        ...
        contactServiceM.getContactNowData(pageNum,pageSize,sort,edition);
    };
    ...
    $scope.$on('getContactNowDataA',function (event,data) {
        ...
        // console.log('that.pageNowConfig.totalItems:'+that.pageNowConfig.totalItems);
        // console.log(2);
    });
    //下载通讯录
    // this.downloadAddress=contactService.downloadAddress(that.pageConfig.edition);
}])
    .controller('contactOldCtrlM',['$scope','contactServiceM',function ($scope,contactServiceM) {
        /**
         *
         *初始化
         */
        ...
        var getContactOldData=function () {
            ...
            //调用contactService服务里的getContactData方法，将赋值好的数据传递回给后台
            contactServiceM.getContactOldData(pageNum,pageSize,sort,edition);
        };
    ...
    .controller('saveData',['$scope','contactServiceM',function ($scope,contactServiceM) {
        var that=this;
        var allEdition=[];
        this.pageOldConfig={
            //当前的页数
        ...
        this.changeEdition=function (editionModel) {
            ...
            //console.log('edition:'+edition);
            //调用contactService服务里的getContactData方法，将赋值好的数据传递回给后台
            contactServiceM.getContactOldData(pageNum,pageSize,sort,editionModel);
        };

        contactServiceM.getEdition();
