/**
 * Based on tm.pagination(https://github.com/miaoyaoyao/AngularJs-UI)
...
angular.module('myPagination', [])
    ...
    return {
        ...
        template: '<div  class="page-list">' +
                    '<ul style="margin:0" id="pageSetUl" class="pagination pull-left" ng-if="conf.totalItems > 0">' +
                        ...
                        '</li>' +
                    '</ul>' +
                    '<div class="page-total pull-right" ng-if="conf.totalItems > 0">' +
                        '<span class="control-label pull-left">每页显示&nbsp;&nbsp;</span>' +
                        '<select class="form-control pull-left" ng-model="conf.itemsPerPage" ng-options="option for option in conf.perPageOptions " ng-change="changeItemsPerPage()"></select>' +
                        '<span class="control-label pull-left">&nbsp;&nbsp;/共{{ conf.totalItems }}条</span> ' +
                    '</div>' +
                    '<div class="no-items" ng-if="conf.totalItems <= 0">暂无数据</div>' +
                  '</div>',
        replace: true,
        scope: {
            conf: '='
